...
export default function FichesEnCours(){
    const [LesFiches, setFiches] = useState([]);
      ...
      useEffect(() => {
        ...
        const fetchFiches = async () => {
          ...
          const lien = role==="Technicien" ? `http://localhost:8080/intervention/getFichesByMatriculeNV/${matricule}` : `http://localhost:8080/intervention/getFiches/${agence}`;
      ...
      return (
        <div style={{ padding: "20px" }}>
          <h1 className="text-2xl text-gray-900 w-full text-center">Fiches non validées</h1>
