...
/*
    const ConfirmInterv = (e) => {
        ...
        .then(data => {
            if(data.success){
                setMessage("Confirmation de l'intervention réussie !");
            } else {
...
*/
    return <div id="confirmation-intervention" className="flex flex-wrap place-content-center min-h-screen">
        <form className="border-2 border-solid border-slate-300 py-6 px-6 rounded-sm bg-slate-50">
            ...
            <input type="submit" value="Enregistrer ma fiche au format PDF" className="bg-rose-700 hover:bg-rose-950 hover:text-white py-2 px-4 rounded-full cursor-pointer" />
        </form>
